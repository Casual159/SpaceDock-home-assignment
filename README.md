...
**Epic and User stories overview**
   
🛰️ EPIC 1 — Ship Traffic Monitoring

Goal: Provide real-time overview of ships around and within the station.
...
Actors:
Space Traffic Controller · Station Director (read-only)

⸻

🔗 EPIC 2 — Docking & Undocking Operations

Goal: Enable operational handling of physical docking processes.
...
Goal: Manage formal approval workflow for docking and departure.
...
Actors:
Ship Captain · Space Traffic Controller · Station Director · Audit System

⸻

🔄 EPIC 4 — Ship Status & State Management

Goal: Ensure consistent and valid lifecycle of ship states.
...
Actors:
System · Space Traffic Controller

⸻

📡 EPIC 5 — Ship Communication Integration

Goal: Enable secure communication between station and ships.
...
Actors:
Space Traffic Controller · External Comms System

⸻

📅 EPIC 6 — Flight Schedule Management

Goal: Manage planned arrivals and departures.
...
Goal: Manage financial aspects of docking operations.
...
Goal: Ensure regulatory compliance and passenger validation.
...
Goal: Provide arrival/departure information for station crew and visitors.
...
Goal: Inform stakeholders about critical workflow events.
